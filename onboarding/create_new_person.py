...
from onboarding.database import init_database, add_person, get_person_by_name
...
NEW_USERS_DIR = ONBOARDING_DIR / "new_users"
FACE_DATABASE_DIR = ONBOARDING_DIR.parent / "face_database"
FACE_CACHE_PATH = ONBOARDING_DIR.parent / "deepface" / "db_embeddings.pkl"
...
def process_new_users():
    ...
    if processed_count > 0:
        ...
        print(f"[Info] Database location: {ONBOARDING_DIR / 'persons.db'}")
